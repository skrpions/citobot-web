...
export class ConsultarComponent implements OnInit, OnDestroy {
    ...
    displayedColumns: string[] = ['Identificacion', 'Fecha', 'Mensaje', 'Acciones'];
    ...
    private async detallePaciente(tamizaje: Tamizaje) {
        ...
        await this.pacienteService.getPacienteById(tamizaje.per_identificacion!).subscribe((res) => {
            ...
            if (res.codigoRespuesta === 0) {
                ...
                this.dialog.open(DetalleTamizajeComponent, { data: { Tamizaje: tamizaje, NombrePaciente: this.nombreCompleto } });
