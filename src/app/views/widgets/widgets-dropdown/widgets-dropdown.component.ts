...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
    ...
    constructor(
        ...
        private riesgoSvc: NivelRiesgoService,
    ) { }
    ...
    ngOnInit(): void {
        ...
        this.obtenerTotalTamizajes();
        this.obtenerTotalRiesgos();
    ...
    // Usuarios
    private obtenerTotalUsuarios(): void {
        this.usuarioSvc.getUsuarios().subscribe((res) => {
            if (res.objetoRespuesta.length) {
                this.totalUsuarios = res.objetoRespuesta.length;
            }
        });
    }
    ...
    // Riesgos
    private obtenerTotalRiesgos(): void {
        this.riesgoSvc.getNivelesRiesgos().subscribe((res) => {
            if (res.objetoRespuesta.length) {
                this.totalRiesgos = res.objetoRespuesta.length;
            }
        });
    }
