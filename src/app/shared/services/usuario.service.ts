...
export class UsuarioService {
  ...
  public getUsuarioLogueado() {
    ...
    this.getUsuarioByEmail(this.usuario_email).subscribe((usuario) => {
  ...
  getUsuarios(): Observable<any> {
    return this.http.get<any>(`${this.enviromentUrl}/usuarios/consultar`, {
  ...
  getUsuarioById(id: number): Observable<any> {
    return this.http.get<Usuario>(
      `${this.enviromentUrl}/usuarios/identificacion?id=${id}`,
      { headers: this.headers }
    );
  }
  ...
  getUsuarioByTipoId(Tipoid: string): Observable<any> {
    return this.http.get<Usuario>(
      `${this.enviromentUrl}/usuarios/tipoId?tipo_id=${Tipoid}`,
      { headers: this.headers }
    );
  }
  ...
  getUsuarioByEmail(email: string): Observable<any> {
    return this.http.get<Usuario>(
      `${this.enviromentUrl}/usuarios/email?email=${email}`,
      { headers: this.headers }
    );
  }
  ...
  changeStateUser(id: number, form: any) {
    return this.http.put<any>(
      `${this.enviromentUrl}/usuarios/actualizarEstado/${id}`,
      form,
      { headers: this.headers }
    );
  }
  ...
  createUsuario(form: Usuario): Observable<any> {
    return this.http.post<Usuario>(
      `${this.enviromentUrl}/usuarios/crear`,
      form,
      {
        headers: this.headers,
      }
  ...
  updateUsuario(id: number, form: Usuario): Observable<any> {
    return this.http.put<Usuario>(
      `${this.enviromentUrl}/usuarios/actualizar/${id}`,
      form,
      { headers: this.headers }
    );
  }
  ...
  deleteUsuario(id: number): Observable<any> {
    return this.http.delete<any>(
      `${this.enviromentUrl}/usuarios/eliminar/${id}`,
      {
        headers: this.headers,
      }
    );
